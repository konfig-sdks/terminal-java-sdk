...
public class ProvidersApiGenerated {
    ...
    private ApiResponse<Void> getListWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getListValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call getListAsync(final ApiCallback<Void> _callback) throws ApiException {
